let phrases = [
    { text: ' спросить где мой ByratBook', image: 'https://code.s3.yandex.net/web-code/procrastinate/1.gif' },
    { text: 'посмотреть скидки на авиабилеты в Москву', image: 'https://code.s3.yandex.net/web-code/procrastinate/2.png' },
    { text: 'слушать скриптонита или фонк', image: 'https://code.s3.yandex.net/web-code/procrastinate/3.png' },
    ...
    { text: 'мечтать уехать в Сан-Франциско', image: 'https://code.s3.yandex.net/web-code/procrastinate/6.png' },
